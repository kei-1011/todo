...
<ul class="folder-list">
    ...
    <?php foreach($folders as $folder){?>
      <li class="folder-item"><a href="index.php?folder_id=<?php echo $folder['id'];?>" class="folder-link <?php if($_GET['folder_id'] == $folder['id']) { echo 'current'; }?>"><?php echo $folder['title'];?></a><a href="update.php?folder_id=<?php echo $folder['id'];?>" class="folder-update">編集</a></li>
    <?php }?>
    </ul>
